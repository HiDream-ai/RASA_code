...
from .utils import load_state_dict, init_weights_on_device, hash_state_dict_keys, split_state_dict_with_prefix, custom_load_state_dict_from_safetensors, custom_load_state_dict_from_safetensors_vace
...
def load_model_from_single_file(state_dict, model_names, model_classes, model_resource, torch_dtype, device):
    ...
    for model_name, model_class in zip(model_names, model_classes):
        ...
        #         target_dict[k] = model_state_dict[k].clone()
        #     else:
        ...
        # model.load_state_dict(target_dict, assign=True)  ##changed
