...
class LowMemoryArrayList:
    def __init__(self, array_list=None):
        self.file_list = array_list
    
    def __len__(self):
        return len(self.file_list)

    def __getitem__(self, item):
        return Image.fromarray(self.file_list[item]).convert("RGB")
...
class VideoData:
    def __init__(self, video_file=None, image_folder=None, array_list=None, height=None, width=None, **kwargs):
        if video_file is not None:
            ...
            self.data_type = "plot"
            self.data = LowMemoryArrayList(array_list, **kwargs)
        else:
